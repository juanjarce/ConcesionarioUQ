...
public class TablaReporteDeNegocios extends JFrame {
	 ...
	 * Create the frame.
	 */
	public TablaReporteDeNegocios(Empleado miEmpleado) {
	
		this.miEmpleado = miEmpleado;
		setTitle("TABLA REPORTE");
	...
	{
		List<Transaccion> listaTransaccionesEmpleado = miEmpleado.obtenerResgitroTransaccionesEmpleado();
		
		for(Transaccion transaccion : listaTransaccionesEmpleado) {
			try {
